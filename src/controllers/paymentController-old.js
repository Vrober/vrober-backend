...
const cashfreeInstance = new Cashfree({
	mode: cashfreeConfig.environment === "production" ? "prod" : "sandbox",
});

// Set credentials
cashfreeInstance.setCredentials({
	appId: cashfreeConfig.clientId,
	secretKey: cashfreeConfig.clientSecret,
});
...
export const verifyPayment = async (req, res) => {
	try {
		...
		try {
			...
			console.error("Cashfree fetch error:", cfError);
		}
